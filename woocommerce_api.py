...
# -*- coding: utf-8 -*-
"""
Modulo WooCommerce API per Gestionale Gitemania (Versione Finale con Paginazione Corretta e Robusta)
"""
...
class WooCommerceManager:
    ...
    def get_orders(self, params: dict = None, paginate_all: bool = False) -> Optional[List[dict]]:
        ...
        while True:
            try:
                current_params = {'per_page': per_page, 'page': page, 'orderby': 'date', 'order': 'desc', 'status': 'any'}
                ...
                if response.status_code == 200:
                    ...
                    if not paginate_all or len(orders_page) < per_page:
                        break
